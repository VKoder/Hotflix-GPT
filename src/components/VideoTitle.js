const VideoTitle = ({original_title, overview}) => {
    return (
        <div className="w-screen aspect-video pt-[20%] lg:px-20 md:px-16 sm:px-6 px-4 overflow-hidden bg-gradient-to-r from-black ">
            <div className="flex justify-start items-start flex-col">
            <span className="lg:w-5/12 md:w-7/12 sm:w-7/12 w-7/12 lg:text-4xl md:text-2xl  text-lg sm:text-xl text-white font-bold">{original_title}</span>
